...
const posts = [
  ...
  },
  {
    author: "부동산초보",
    time: "12시간 전",
    title: "강릉 전월세 가격대가 어떻게 되나요?",
    body: "강릉에서 원룸을 구하려고 하는데 평균 가격대를 알고 싶습니다. 최근 정보 있으신 분?",
    image: images.room,
    likes: 15,
    comments: 9,
    category: "질문/답변",
  },
  {
    author: "맛집헌터",
    time: "18시간 전",
    title: "강릉 꼭 가야 할 로컬 음식점 5곳 🍜",
    body: "강릉에서 관광객이 모르는 진짜 맛집들을 소개합니다. 1. 동해안 회 식당...",
    image: images.market,
    likes: 45,
    comments: 18,
    category: "정보 공유",
  },
  {
    author: "직장인A",
    time: "1일 전",
    title: "강릉에서 일하고 있는 사람들 모임 만들어요",
    body: "리모트로 일하거나 강릉에서 일하는 분들끼리 정보 공유하고 친목할 모임을 만들고 싶습니다!",
    image: images.work,
    likes: 22,
    comments: 11,
    category: "모임/행사",
  },
  {
    author: "학부모",
    time: "2일 전",
    title: "강릉 아이들 키우기 어떤가요?",
    body: "초등학교 다니는 아이와 함께 강릉으로 이주를 생각 중입니다. 학교는 어떤지, 생활 환경은 어떤지 궁금합니다.",
    image: images.beach,
    likes: 12,
    comments: 7,
    category: "질문/답변",
  },
  {
    author: "건강매니아",
    time: "2일 전",
    title: "강릉에서 요가/필라테스 할 수 있는 곳 추천해주세요",
    body: "강릉에서 좋은 요가나 필라테스 스튜디오를 찾고 있습니다. 추천 부탁드려요!",
    image: images.beach,
    likes: 8,
    comments: 5,
    category: "질문/답변",
  },
  {
    author: "사진작가",
    time: "3일 전",
    title: "강릉 일출 명소 소개합니다 📸",
    body: "정동진, 경포대, 추암 등 강릉의 최고의 일출 명소들을 촬영한 사진들입니다. 정보 공유합니다!",
    image: images.beach,
    likes: 58,
    comments: 22,
    category: "정보 공유",
  },
  {
    author: "커피매니아",
    time: "3일 전",
    title: "강릉 카페거리 완벽 가이드 ☕",
    body: "강릉 카페거리에서 꼭 가봐야 할 카페 10곳을 정리했습니다. 분위기, 가격, 추천 메뉴까지!",
    image: images.cafe,
    likes: 67,
    comments: 25,
    category: "정보 공유",
